...
function jt(e) {
  ...
  }), q.get(p) === 1 && (p.addEventListener("dblclick", De, true), p.addEventListener("pointerdown", Oe, true), p.addEventListener("pointerleave", _e2), p.addEventListener("pointermove", $e), p.addEventListener("pointerout", He), p.addEventListener("pointerup", Ve, true)), function() {
    t = false, q.set(
      p,
      ...
      Oe,
      true
    ), p.removeEventListener("pointerleave", _e2), p.removeEventListener("pointermove", $e), p.removeEventListener("pointerout", He), p.removeEventListener("pointerup", Ve, true)), a.disconnect();
  };
}
function Bt() {
...
var st = (0, import_react.createContext)(null);
function Wt(e, t) {
...
function Ut({
  ...
  const x = (0, import_react.useRef)({
    ...
    j(x.current.onLayoutChange, b) || (x.current.onLayoutChange = b, s == null ? void 0 : s(b));
  }), h = ne((b) => {
    j(x.current.onLayoutChanged, b) || (x.current.onLayoutChanged = b, l == null ? void 0 : l(b));
  }), g = xe(i), y = (0, import_react.useRef)(null), [z, S] = Bt(), d = (0, import_react.useRef)({
  ...
  }), (0, import_jsx_runtime.jsx)(st.Provider, { value: X, children: (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...v,
      className: t,
...
function nn({
  ...
  const r = t !== void 0, a = "id" in o ? o.id : o.groupId, u = me(a, t ?? []), i = (0, import_react.useSyncExternalStore)(
    Kt,
    () => n.getItem(u),
    () => n.getItem(u)
    ...
    [i]
  ), l = (0, import_react.useRef)(null), c = (0, import_react.useCallback)(() => {
    const v = l.current;
...
function Le() {
  const e = (0, import_react.useContext)(st);
  return L(
    e,
...
function Xt(e, t) {
  const { id: n } = Le(), o = (0, import_react.useRef)({
    collapse: he,
    expand: he,
    getSize: () => ({
      asPercentage: 0,
...
function qt({
  ...
  const f = !!s, h = xe(s), g = Pe({
    disabled: a
  }), y = (0, import_react.useRef)(null), z = we(y, u), {
    getPanelStyles: S,
    id: d,
    orientation: P,
    registerPanel: R,
  ...
  const b = (0, import_react.useSyncExternalStore)(
    (w) => ye(d, w),
...
function Zt({
  ...
  const i = xe(r), s = Pe({
    disabled: n
  }), [l, c] = (0, import_react.useState)({}), [m, p] = (0, import_react.useState)("inactive"), v = (0, import_react.useRef)(null), x = we(v, o), {
    disableCursor: f,
    id: h,
    orientation: g,
    registerSeparator: y,
  ...
  }, [h, i, y, s]), (0, import_react.useEffect)(() => {
    z(i, !!n);
  }, [n, i, z]);
  let d;
  return n && !f && (d = "not-allowed"), (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...u,
