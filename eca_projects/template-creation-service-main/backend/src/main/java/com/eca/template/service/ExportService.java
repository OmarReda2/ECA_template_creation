...
public class ExportService {
    ...
    public String getExportFilename(UUID versionId, String requestFileName) {
        ...
        // validation: return filename after sanitizing and appending ".xlsx"
        ...
        // if file name is null: find version & template related to generate file name based on them (if not specified)
        ...
        // extract template name from retrieved version, and generate file name based on  template and version
